...
def export_onnx(model, im, file, opset, train, dynamic, simplify, prefix=colorstr('ONNX:')):
    # YOLOv5 ONNX export
    my_export_onnx(model, im, file, opset, train, False, simplify)
    try:
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'y5s6b8t.pt', help='model.pt path(s)')
